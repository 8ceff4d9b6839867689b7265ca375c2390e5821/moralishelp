...
const baseImageUri = "my server";
// id for edition to start from
const startEditionFrom = 1;
// amount of NFTs to generate in edition
const editionSize = 64;
...
const layers = [
  addLayer("1background", { x: 0, y: 0 }, { width: width, height: height }),
  addLayer("2ellipses", { x: 14, y: 14 }, { width: 404, height: 404 }),
  addLayer("3stars", { x: 36, y: 63 }, { width: 360, height: 344 }),
  addLayer("4words", { x: 152, y: 195 }, { width: 130, height: 46 }),
];
...
addRarityPercentForLayer("original", "3stars", {
  super_rare: 25,
  rare: 25,
  original: 50,
});
addRarityPercentForLayer("original", "1background", {
  super_rare: 25,
  rare: 25,
  original: 50,
});
addRarityPercentForLayer("original", "2ellipses", {
  super_rare: 25,
  rare: 25,
  original: 50,
});
addRarityPercentForLayer("original", "4words", {
  super_rare: 25,
  rare: 25,
  original: 50,
});
